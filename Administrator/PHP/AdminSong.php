...
?>
    ...
    <head>
        ...
        <title>THE Music | Administrator Page</title>
    ...
    <body>
        ...
        <div class="container_wrapper">
            ...
            <div class="sidebar_menu">
                <div>
                    <h4 class="header">THE Music Menu</h4>
                </div>
                <ul>
            ...
            <div class="home_content">
                ...
                <form id="form" method="post" name="form" enctype="multipart/form-data" action="AdminAddSong.php" target="uploadframe">
                    <div>
                        <iframe src="" id="uploadframe" name="uploadframe" style="width:0px; height:0px; border:0px;"></iframe>
                    </div>
                    <div>
